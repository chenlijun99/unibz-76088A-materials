...
// Try to remove volatile and compile with optimizations turned on
volatile static bool button_toggle_status;
...
void app_main(void) {
  ...
  button_toggle_status = false;
  while (1) {
    while (button_toggle_status || !s_led_state) {
