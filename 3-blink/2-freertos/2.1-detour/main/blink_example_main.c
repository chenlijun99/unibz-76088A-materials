...
static void input_task(void *params) {
  ...
  while (1) {
    printf("(%s) Insert red intensity\n", name);
    scanf("%d", &g_task_shared.red);
    printf("(%s) red: %d\n", name, g_task_shared.red);

    printf("(%s) Insert green intensity\n", name);
    scanf("%d", &g_task_shared.green);
    printf("(%s) green: %d\n", name, g_task_shared.green);

    printf("(%s) Insert blue intensity\n", name);
    scanf("%d", &g_task_shared.blue);
    printf("(%s) blue: %d\n", name, g_task_shared.blue);
...
void app_main(void) {
  ...
  xTaskCreate(input_task, NULL, 0x1024, name1, tskIDLE_PRIORITY + 1, NULL);
  xTaskCreate(input_task, NULL, 0x1024, name2, tskIDLE_PRIORITY + 1, NULL);
}
